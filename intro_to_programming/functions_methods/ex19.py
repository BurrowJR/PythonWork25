...
'''
In this code we will use the all() function to show whether all the numbers are not divisible by 5.
0 = falsy = divisible by 5 = False
All other integers = truthy = NOT divisible by 5 = True
'''